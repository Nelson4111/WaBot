...
const ikanEmoji = {
  ...
  davy_jones: '🦑', caylpso: '💧', worm_fish: '🪱', zombie_shark: '🦈', skeleton_shark: '🦴', ariel_little_mermaid: '🌊',
  treasure_chest: '💎', ancient_relic: '🏺', pirate_gold: '💰', mermaid_tear: '💧',
  kraken: '🦑', megladon: '🦈', leviathan: '🐉', sea_dragon: '🐲',
  ikan_phoenix: '🔥', hydra_laut: '🐍', cerberus_laut: '🐺', titan_kura: '🐢',
  paus_putih: '🐋', ikan_dewa: '✨', naga_laut: '🐉', raja_ubur: '👑',
  penjaga_karang: '🪸', putri_duyung: '💎', dewa_katak: '🐸', kuda_laut_kristal: '🐴',
  peti_karun: '💰', koin_emas_kuno: '🪙', mutiara_raja: '👑', mahkota_karang: '👑',
  hiu_putih: '🦈', hiu_harimau: '🦈', hiu_martil: '🦈', paus_orca: '🐋',
  paus_biru: '🐋', penyu_raksasa: '🐢', ikan_pari_manta: '🪼', ikan_napoleon: '🐟',
  ...
  ikan_malaikat: '🐠', ikan_diskus: '🐠', ikan_arwana: '🐟', ikan_arapaima: '🐟',
  piranha: '🐟', belut_listrik: '🐍', ikan_duyung: '🌊', ubur_ubur_bulan: '🌙',
  bintang_laut: '⭐', anemon_laut: '🌸', karang_indah: '🪸', kerang_mutia: '🐚',
  siput_laut: '🐌', landak_laut: '🦔', peti_besi: '📦', koin_emas: '🪙', mutiara_hitam: '⚫', trisula_patah: '🔱',
  hiu_hitam: '🦈', hiu_biru: '🦈', lumba_lumba: '🐬', paus_pembunuh: '🐋',
  penyu_hijau: '🐢', ikan_pari: '🪼', kerapu: '🐟', tuna: '🐟', salmon: '🐟',
  barakuda: '🐟', ikan_todak: '🐟', ikan_terbang: '🐟', ubur_ubur: '🪼',
  ...
  lobster: '🦞', kerang_hijau: '🐚', kerang_darah: '🐚', siput: '🐌',
  ...
  ikan_gurame: '🐟', ikan_mujair: '🐟', ikan_gabus: '🐟', ikan_wader: '🐟',
  ikan_seluang: '🐟', ikan_teri: '🐟', ikan_pepetek: '🐟', ikan_layang: '🐟',
  ikan_kembung_kecil: '🐟', ikan_selar: '🐟', ikan_tembang: '🐟', ikan_julung: '🐟',
  sampah_plastik: '🗑️', ban_bekas: '🛞', botol_kaca: '🍶', kaleng: '🥫',
  kayu_hanyut: '🪵', jaring_rusak: '🕸️', sepatu: '👟', botol: '🍶',
  kantong_plastik: '🛍️', duri: '🌵', batu: '🪨', rumput: '🌿', lumpur: '🟤',
  daun: '🍃', ranting: '🌿', tali: '🪢', kawat: '🔩', pecahan_kaca: '💔',
  kaos_kaki: '🧦', mie_instan: '🍜', pakaian_dalam: '🩲',
  kaiju: '🐉', kadita: '💎'
}

Object.keys(ikanEmoji).forEach((key) => {
  ikanEmoji[key] = safeEmoji(ikanEmoji[key])
})
...
for (let t of urutan) {
  if (grouped[t]) {
    ...
    cap += `│ Koleksi ikan berdasarkan tier.\n`
    cap += `╰─━━━━━━━━━━━━━━─\n`

    grouped[t].list.forEach((v) => {
      cap += `> *${nomor++}. ${formatNama(v.nama)} ${v.emoji}* x${v.jml.toLocaleString()}\n`
    })
