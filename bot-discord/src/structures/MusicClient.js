...
class MusicBot extends Client {
  constructor() {
    let clusterInfo = { SHARD_LIST: undefined, TOTAL_SHARDS: undefined };
    try {
      clusterInfo = getInfo();
    } catch (_) {}
    ...
    if (clusterInfo.SHARD_LIST !== undefined) clientOptions.shards = clusterInfo.SHARD_LIST;
    if (clusterInfo.TOTAL_SHARDS !== undefined) clientOptions.shardCount = clusterInfo.TOTAL_SHARDS;
