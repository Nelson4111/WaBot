...
function bind(conn) {
            ...
            for (let { id, name, readOnly } of chats) {
                ...
                if (isGroup && !chats.metadata) {
                    ...
                    if (metadata) {
                        ...
                        if (global.updateGroupMetadataCache) global.updateGroupMetadataCache(id, metadata)
                    }
                }
            }
        } catch (e) {
    ...
    conn.ev.on('group-participants.update', async function updateParticipantsToDb({ id, participants, action }) {
        ...
        if (global.updateGroupMetadataCache) global.updateGroupMetadataCache(id, groupMetadata)
    })
