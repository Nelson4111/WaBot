...
export const TWILY_MC = []
export const TWILY_ROBLOX = []
...
export function syncTwilyFromDb(force = false) {
  ...
  TWILY_MC.length = 0
  TWILY_MC.push(...(Array.isArray(source.mc) ? source.mc : []))

  TWILY_ROBLOX.length = 0
  TWILY_ROBLOX.push(...(Array.isArray(source.roblox) ? source.roblox : []))
