...
/**
 * HermesBridge.js — Avelia Official Hermes Agent Bridge (Phase C Hardened)
 * 
 * Jembatan komunikasi HTTP antara Avelia (Node.js/Baileys) dan Hermes Agent resmi (Nous Research).
...
export class HermesBridge {
    constructor(options = {}) {
        ...
        this.timeoutMs = options.timeoutMs || 90000; // 90 detik untuk full agentic action
