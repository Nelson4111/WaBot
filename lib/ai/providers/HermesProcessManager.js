 ...
 * - Menangani shutdown bersih (graceful cleanup) saat Avelia berhenti
    ...
    async ensureRunning(maxWaitMs = 15000) {
        ...
        try {
            ...
            this.childProcess.on('error', (err) => {
                console.warn(`[HermesProcessManager] Gagal menjalankan proses Hermes: ${err.message}. Avelia akan menggunakan fallback AI.`);
                this.childProcess = null;
            });
