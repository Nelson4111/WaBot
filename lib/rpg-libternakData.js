...
'godzilla': { emoji: '🦖', nama: 'Godzilla', hargaBibit: 5200000, hargaJual: 32000000, hasilDaging: 'Daging Godzilla 🥩', hasil: 'Sisik Godzilla 🐉', exp: 1150, tipe: 'all', evolusi: 3, desc: 'Kaiju raksasa dengan tenaga atom dan daya hancur luar biasa.' },
'king_kong': { emoji: '🦍', nama: 'King Kong', hargaBibit: 5000000, hargaJual: 31000000, hasilDaging: 'Daging King Kong 🥩', hasil: 'Bulu King Kong 🧶', exp: 1120, tipe: 'all', evolusi: 3, desc: 'Primata raksasa yang kuat, cerdas, dan sangat tangguh.' },
'ender_dragon': { emoji: '🐉', nama: 'Ender Dragon', hargaBibit: 5600000, hargaJual: 35000000, hasilTelur: 'Telur Ender Dragon 🥚', hasilDaging: 'Sisik Ender Dragon 🐉', exp: 1250, tipe: 'all', evolusi: 3, desc: 'Naga penguasa dimensi End dan sumber energi ender.' },
'enderman': { emoji: '🕴️', nama: 'Enderman', hargaBibit: 4300000, hargaJual: 27000000, hasilDaging: 'Mutiara Ender 🟣', hasil: 'Blok Ender 🟪', exp: 1050, tipe: 'all', evolusi: 3, desc: 'Makhluk ender yang dapat berpindah tempat dan mengangkat blok.' },
'warden': { emoji: '👹', nama: 'Warden', hargaBibit: 6200000, hargaJual: 41000000, hasilDaging: 'Inti Warden 💠', hasil: 'Sculk Warden 🟦', exp: 1400, tipe: 'all', evolusi: 4, desc: 'Penjaga bawah tanah dengan pendengaran dan kekuatan dahsyat.' },
'ravager': { emoji: '🐗', nama: 'Ravager', hargaBibit: 4700000, hargaJual: 29000000, hasilDaging: 'Daging Ravager 🥩', hasil: 'Kulit Ravager 👜', exp: 1100, tipe: 'all', evolusi: 3, desc: 'Monster penyerbu besar dengan daya hancur tinggi.' },
'elder_guardian': { emoji: '🐡', nama: 'Elder Guardian', hargaBibit: 4900000, hargaJual: 30000000, hasilDaging: 'Daging Elder Guardian 🥩', hasil: 'Prismarine Kuno 🟦', exp: 1130, tipe: 'all', evolusi: 3, desc: 'Penjaga laut tua dengan kekuatan dan duri yang berbahaya.' },
'wither': { emoji: '💀', nama: 'Wither', hargaBibit: 5400000, hargaJual: 34000000, hasilDaging: 'Inti Wither 💀', hasil: 'Bintang Nether ⭐', exp: 1220, tipe: 'all', evolusi: 3, desc: 'Monster undead berkepala tiga yang membawa kehancuran.' },
'ender_dragon_ancient': { emoji: '🐲', nama: 'Ancient Ender Dragon', hargaBibit: 6500000, hargaJual: 42000000, hasilTelur: 'Telur Ancient Ender 🥚', hasilDaging: 'Sisik Ancient Ender 🐉', exp: 1450, tipe: 'all', evolusi: 4, desc: 'Evolusi purba Ender Dragon dengan energi ender yang lebih kuat.' },
'mecha_godzilla': { emoji: '🤖', nama: 'Mecha Godzilla', hargaBibit: 6800000, hargaJual: 45000000, hasilDaging: 'Inti Mecha Godzilla ⚙️', hasil: 'Baja Kaiju ⚙️', exp: 1500, tipe: 'all', evolusi: 4, desc: 'Kaiju mekanik dengan persenjataan dan armor berteknologi tinggi.' },
'king_ghidorah': { emoji: '🐲', nama: 'King Ghidorah', hargaBibit: 7200000, hargaJual: 50000000, hasilTelur: 'Telur King Ghidorah 🥚', hasilDaging: 'Sisik Ghidorah 🐉', exp: 1600, tipe: 'all', evolusi: 4, desc: 'Kaiju naga berkepala tiga dengan kekuatan badai petir.' },
'mothra': { emoji: '🦋', nama: 'Mothra', hargaBibit: 6000000, hargaJual: 38000000, hasilTelur: 'Telur Mothra 🥚', hasilDaging: 'Sayap Mothra 🪽', exp: 1350, tipe: 'all', evolusi: 3, desc: 'Kaiju ngengat raksasa dengan sayap dan energi cahaya.' },
'titan_colossal': { emoji: '🦖', nama: 'Colossal Titan', hargaBibit: 5800000, hargaJual: 37000000, hasilDaging: 'Daging Colossal Titan 🥩', hasil: 'Uap Titan ♨️', exp: 1300, tipe: 'all', evolusi: 3, desc: 'Raksasa titan dengan tubuh panas dan ukuran kolosal.' },
'kaiju_prime': { emoji: '👹', nama: 'Kaiju Prime', hargaBibit: 8000000, hargaJual: 60000000, hasilDaging: 'Daging Kaiju Prime 🥩', hasil: 'Inti Kaiju Prime 💎', exp: 1800, tipe: 'all', evolusi: 5, desc: 'Monster puncak yang menggabungkan kekuatan berbagai kaiju.' },
'kucing': { emoji: '🐈', nama: 'Kucing', hargaBibit: 120000, hargaJual: 300000, hasil: 'Bulu Kucing 🧶', exp: 80, tipe: 'produk', evolusi: 0, desc: 'Hewan jinak yang dapat dijinakkan dan hidup dekat pemain.' },
'rubah': { emoji: '🦊', nama: 'Rubah', hargaBibit: 180000, hargaJual: 450000, hasil: 'Bulu Rubah 🧶', exp: 100, tipe: 'produk', evolusi: 0, desc: 'Hewan malam yang lincah dan dapat ditemukan di taiga.' },
'ocelot': { emoji: '🐆', nama: 'Ocelot', hargaBibit: 220000, hargaJual: 550000, hasil: 'Bulu Ocelot 🧶', exp: 115, tipe: 'produk', evolusi: 0, desc: 'Kucing liar yang hidup di hutan Minecraft.' },
'mule': { emoji: '🐴', nama: 'Mule', hargaBibit: 260000, hargaJual: 650000, hasil: 'Kulit Mule 👜', exp: 105, tipe: 'produk', evolusi: 0, desc: 'Hewan hasil persilangan kuda dan keledai.' },
'burung_beo': { emoji: '🦜', nama: 'Burung Beo', hargaBibit: 200000, hargaJual: 500000, hasil: 'Bulu Burung Beo 🪶', exp: 95, tipe: 'produk', evolusi: 0, desc: 'Burung hutan berwarna-warni yang dapat meniru suara.' },
'ikan_kod': { emoji: '🐟', nama: 'Ikan Kod', hargaBibit: 90000, hargaJual: 220000, hasil: 'Ikan Kod 🐟', exp: 55, tipe: 'daging', evolusi: 0, desc: 'Ikan laut umum di perairan Minecraft.' },
'ikan_salmon': { emoji: '🐟', nama: 'Ikan Salmon', hargaBibit: 110000, hargaJual: 260000, hasil: 'Ikan Salmon 🐟', exp: 65, tipe: 'daging', evolusi: 0, desc: 'Ikan yang banyak ditemukan di sungai dan lautan.' },
'ikan_buntal': { emoji: '🐡', nama: 'Ikan Buntal', hargaBibit: 150000, hargaJual: 380000, hasil: 'Racun Ikan Buntal ☠️', exp: 85, tipe: 'produk', evolusi: 0, desc: 'Ikan beracun yang mengembang ketika terancam.' },
'ikan_tropis': { emoji: '🐠', nama: 'Ikan Tropis', hargaBibit: 170000, hargaJual: 420000, hasil: 'Ikan Tropis 🐠', exp: 90, tipe: 'produk', evolusi: 0, desc: 'Ikan hias dengan banyak pola dan warna.' },
'cumi_cumi': { emoji: '🦑', nama: 'Cumi-Cumi', hargaBibit: 190000, hargaJual: 480000, hasil: 'Tinta Cumi-Cumi 🖋️', exp: 100, tipe: 'produk', evolusi: 0, desc: 'Mob air yang menghasilkan kantung tinta.' },
'cumi_cumi_bercahaya': { emoji: '🦑', nama: 'Cumi-Cumi Bercahaya', hargaBibit: 280000, hargaJual: 700000, hasil: 'Tinta Bercahaya ✨', exp: 140, tipe: 'produk', evolusi: 1, desc: 'Varian cumi-cumi yang hidup di gua bawah air.' },
'lumba_lumba': { emoji: '🐬', nama: 'Lumba-Lumba', hargaBibit: 300000, hargaJual: 750000, hasil: 'Sirip Lumba-Lumba 🐬', exp: 150, tipe: 'produk', evolusi: 1, desc: 'Mob laut cerdas yang dapat membantu menemukan harta.' },
'kura_kura_minecraft': { emoji: '🐢', nama: 'Kura-Kura Minecraft', hargaBibit: 240000, hargaJual: 600000, hasilTelur: 'Telur Kura-Kura 🥚', hasilDaging: 'Daging Kura-Kura 🥩', exp: 125, tipe: 'all', evolusi: 1, desc: 'Mob pantai yang bertelur di pasir dan menghasilkan scute.' },
'kecebong': { emoji: '🐟', nama: 'Kecebong', hargaBibit: 80000, hargaJual: 180000, hasil: 'Lendir Kecebong 🟢', exp: 45, tipe: 'produk', evolusi: 0, desc: 'Bentuk awal katak yang hidup di air.' },
'strider': { emoji: '🐗', nama: 'Strider', hargaBibit: 350000, hargaJual: 900000, hasil: 'Bulu Strider 🧶', exp: 180, tipe: 'produk', evolusi: 1, desc: 'Mob Nether yang dapat berjalan di atas lava.' },
'sniffer': { emoji: '🐢', nama: 'Sniffer', hargaBibit: 900000, hargaJual: 2500000, hasilTelur: 'Telur Sniffer 🥚', hasilDaging: 'Daging Sniffer 🥩', exp: 320, tipe: 'all', evolusi: 2, desc: 'Mob purba yang menemukan tanaman kuno dari tanah.' },
'beruang_kutub': { emoji: '🐻', nama: 'Beruang Kutub', hargaBibit: 320000, hargaJual: 800000, hasilDaging: 'Daging Beruang Kutub 🥩', hasil: 'Bulu Beruang Kutub 🧶', exp: 160, tipe: 'all', evolusi: 1, desc: 'Mob dingin yang menjaga anaknya di wilayah bersalju.' },
}
...
export function listHybrid() {
  ...
  for (let k in hybridDatabase) {
    ...
    hybridIndex++
    txt += `${hybridIndex}. 🧬 *${h.nama} ${h.emoji}*\n`
