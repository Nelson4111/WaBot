...
export const DEVIL_LIST = [
  ...
  { nama: 'Barem Flamethrower', rank: 'S', tipe: 'Fiend', hp: 1800, dmg: 490,  exp: 1100, blood: 5000,  emoji: '🔥', runBlood: 0,  desc: 'Wujud manusia dari Flamethrower Hybrid, membakar area sekitar dengan gas belerang dan kompor pemantik api.' },
  ...
  { nama: 'Katana Devil True',  rank: 'SS', tipe: 'Devil', hp: 9800,  dmg: 2700, exp: 5400, blood: 29000, emoji: '🗡️', runBlood: 0,   desc: 'Wujud Iblis murni seutuhnya dari Katana Man tanpa wadah manusia, memotong dimensi ruang dengan ketajaman absolut.' },
  { nama: 'Crossbow Devil True',rank: 'SS', tipe: 'Devil', hp: 9200,  dmg: 2600, exp: 5300, blood: 28500, emoji: '🏹', runBlood: 300, desc: 'Wujud asal Crossbow Hybrid milik Quanxi, memuntahkan ratusan anak panah berujung tulang yang menghancurkan satu blok kota.' },
  { nama: 'Bomb Devil True',    rank: 'SS', tipe: 'Devil', hp: 10500, dmg: 3000, exp: 5700, blood: 31000, emoji: '💣', runBlood: 0,   desc: 'Esensi murni dari ledakan taktis mesiu Soviet, memicu reaksi berantai misil hulu ledak yang meratakan medan pertempuran.' },
  { nama: 'Flame Devil True',   rank: 'SS', tipe: 'Devil', hp: 10200, dmg: 2900, exp: 5600, blood: 30500, emoji: '🔥', runBlood: 0,   desc: 'Wujud Iblis sejati penyembur api faksi gereja, membakar habis seluruh karbon makluk hidup dalam hitungan milidetik.' },
  { nama: 'Whip Devil True',    rank: 'SS', tipe: 'Devil', hp: 9000,  dmg: 2400, exp: 5000, blood: 27000, emoji: '⛓️', runBlood: 0,   desc: 'Sabetan cambuk konseptual berkecepatan suara, merobek kulit dan memotong pertahanan benteng terkuat Keamanan Publik.' },
  { nama: 'Spear Devil True',   rank: 'SS', tipe: 'Devil', hp: 9400,  dmg: 2650, exp: 5150, blood: 27500, emoji: '🔱', runBlood: 350, desc: 'Tombak takdir pembembus realitas fisik, dilemparkan dari kegelapan neraka untuk menyula jantung mangsanya.' },
  ...
  { nama: 'Quanxi Hybrid Form', rank: 'SS', tipe: 'Fiend', hp: 3600,  dmg: 500,  exp: 2900, blood: 12500, emoji: '🏹', runBlood: 0,   desc: 'Kombinasi kecepatan bertarung assassins China berkecepatan puncak, dibatasi ketahanan wadah mayat manusia.' },
  ...
  { nama: 'Gun Devil Pure',      rank: 'SSS', tipe: 'Devil', hp: 15000, dmg: 7000, exp: 7500,  blood: 50000, emoji: '🔫', runBlood: 0,    desc: 'Manifestasi ketakutan global senjata api, bergerak secepat kilat melintasi benua dan membantai jutaan jiwa dalam hitungan menit.' },
  ...
  { nama: 'Infinity Devil True', rank: 'SSS', tipe: 'Devil', hp: 13000, dmg: 5200, exp: 5800,  blood: 38000, emoji: '♾️', runBlood: 0,    desc: 'Konsep keabadian mutlak, mengunci musuh dalam dimensi ruang berputar yang tidak memiliki celah keluar untuk selamanya.' },
...
export const CHARACTER_LIST = [
    ...
    {nama: 'Tadashi Hasegawa', role: 'Former Minister of Finance', faction: 'Japanese Government', status: 'Human', lokasi: ['Tokyo Devil Detention Center'], needLove: 80, emoji: '💰', bonus: 'Money +1000', dialog: ['Anggaran!', 'Pajak!', 'Hemat!']},
...
export const MAIN_LOCATION_LIST = [
    { nama: "Kamar Denji Lama", desc: "Gubuk kayu sempit tempat Denji dan Pochita tidur bersama di awal cerita.", rateDevil: 0.15 },
    { nama: "Gudang Tua Yakuza", desc: "Tempat Denji dimutilasi di awal cerita sebelum bangkit menjadi Chainsaw Man.", rateDevil: 0.45 },
    { nama: "Stasiun Nerima", desc: "Area stasiun tempat Denji pertama kali bertemu Makima setelah diselamatkan.", rateDevil: 0.25 },
    { nama: "Apartemen Hayakawa", desc: "Tempat tinggal bersama Denji, Aki Hayakawa, dan Power di Tokyo.", rateDevil: 0.10 },
    { nama: "Markas Public Safety", desc: "Kantor pusat pemburu iblis divisi 4 tempat Denji dan rekan-rekan bekerja.", rateDevil: 0.20 },
    { nama: "Hotel Morino", desc: "Lokasi misi melawan Eternity Devil, di mana Divisi 4 terjebak di lantai 8.", rateDevil: 0.65 },
    { nama: "Apartemen Himeno", desc: "Rumah pribadi Himeno tempat Denji terbangun di kasurnya setelah pesta penyambutan.", rateDevil: 0.15 },
    { nama: "Stasiun Kyoto", desc: "Stasiun kereta tempat Makima ditumpangi and ditembak oleh komplotan Katana Man.", rateDevil: 0.40 },
    { nama: "Kuil Omiwa", desc: "Kuil di Kyoto tempat Makima mengeksekusi tumbal narapidana dari jarak jauh.", rateDevil: 0.30 },
    { nama: "Distrik Shinjuku", desc: "Area jalanan padat tempat terjadinya pertarungan besar klimaks melawan Katana Man.", rateDevil: 0.55 },
    { nama: "Rumah Sakit Tokyo (Hospital)", desc: "Tempat Aki dirawat setelah arc Katana Man, sekaligus lokasi ia menangisi Himeno.", rateDevil: 0.20 },
    { nama: "Hutan Tempat Latihan Kishibe (Forest)", desc: "Hutan terpencil tempat Denji dan Power disiksa serta dilatih bertarung oleh Kishibe.", rateDevil: 0.35 },
    { nama: "Makam Keluarga Hayakawa", desc: "Area pemakaman bersalju di wilayah utara Hokkaido tempat Aki rutin berziarah.", rateDevil: 0.10 },
    { nama: "Kafe Crossroads (Trois Bagues Vertes)", desc: "Tempat Reze bekerja sebagai barista paruh waktu yang sering dikunjungi Denji.", rateDevil: 0.25 },
    { nama: "Stan Telepon Umum Nishi-Kanda (Phonebooth)", desc: "Tempat ikonik saat Denji berteduh dari hujan dan pertama kali bertemu Reze.", rateDevil: 0.20 },
    { nama: "Tangga Onnazaka", desc: "Tangga curam ikonik yang menjadi rute jalan dan lokasi kencan Denji bersama Reze.", rateDevil: 0.25 },
    { nama: "Gereja Kuno (Church)", desc: "Gedung gereja tua tempat Reze mengurung dan membantai para pemburu iblis.", rateDevil: 0.50 },
    { nama: "Gudang Pelabuhan (Warehouse)", desc: "Lokasi pertempuran malam hari saat Denji disergap oleh Reze (Bomb Devil).", rateDevil: 0.60 },
    { nama: "Kuburan Massal Pemburu Iblis (Graveyard)", desc: "Pemakaman umum tempat Kishibe dan Makima mengobrol tentang rekan yang gugur.", rateDevil: 0.30 },
    { nama: "Bioskop Tokyo (Movie Theater)", desc: "Tempat kencan seharian penuh antara Denji and Makima, di mana mereka menonton banyak film.", rateDevil: 0.15 },
    { nama: "Neraka (Hell)", desc: "Dimensi asal para iblis yang digambarkan dengan langit penuh ribuan pintu melayang.", rateDevil: 0.95 },
    { nama: "Fasilitas Pengolahan Limbah", desc: "Tempat terpencil di mana Makima memanggil seluruh bawahannya untuk menghadapi Gun Devil.", rateDevil: 0.70 },
    { nama: "Kamar Kos Baru Denji", desc: "Tempat tinggal sewaan Denji di Part 2 untuk menghidupi Nayuta dan merawat kumpulan anjing.", rateDevil: 0.25 },
    { nama: "Rumah Kos Asa Mitaka", desc: "Kamar kos sederhana milik Asa Mitaka, tempat ia menyendiri dan berbicara dengan Yoru.", rateDevil: 0.35 },
    { nama: "SMA Fourth East", desc: "Sekolah tempat Asa Mitaka, Denji, Hirofumi Yoshida, dan Haruka Iseumi belajar.", rateDevil: 0.40 },
    { nama: "Akuarium Kota", desc: "Tempat kencan Asa Mitaka dan Denji, di mana mereka terjebak Eternity Devil kedua kalinya.", rateDevil: 0.65 },
    { nama: "Gereja Chainsaw Man", desc: "Markas besar organisasi kultus massal yang dipimpin oleh Fami (Famine Devil).", rateDevil: 0.50 },
    { nama: "Tokyo Devil Detention Center", desc: "Fasilitas bawah tanah rahasia milik militer untuk menahan iblis dan hibrida.", rateDevil: 0.85 }
];

export const SIDE_LOCATION_LIST = [
    { nama: "Apartemen Korban Bat Devil", desc: "Kamar sepi tempat Bat Devil menyandera Meowy, kucing kesayangan milik Power.", rateDevil: 0.50 },
    { nama: "Toko Roti Murah Tokyo", desc: "Tempat Denji membeli roti sisa atau selai murah dengan sisa uang recehnya di awal cerita.", rateDevil: 0.10 },
    { nama: "Gang Belakang Apartemen", desc: "Tempat pembuangan sampah di mana Denji menemukan anak anjing terlantar mirip Pochita.", rateDevil: 0.20 },
    { nama: "Atap Gedung Koun (Nerima)", desc: "Atap bangunan tempat Power pertama kali pamer kekuatan darah dengan melompat.", rateDevil: 0.35 },
    { nama: "Kedai Ramen Pinggir Jalan", desc: "Tempat makan sekilas tempat Himeno mengobrol santai mengenai masa lalu Aki kepada Denji.", rateDevil: 0.15 },
    { nama: "Toko Pakaian Dalam", desc: "Toko pakaian yang dikunjungi Denji bersama Power untuk membelikan Power bantalan dada.", rateDevil: 0.10 },
    { nama: "Supermarket Tokyo", desc: "Tempat Aki, Denji, and Power berbelanja bahan makanan bulanan sambil bertengkar.", rateDevil: 0.15 },
    { nama: "Rooftop Pusat Perbelanjaan", desc: "Tempat Katana Man dan Sawatari pertama kali menghadang Denji sebelum transformasi.", rateDevil: 0.45 },
    { nama: "Kedai Udon & Sushi", desc: "Tempat makan langganan pasca-misi, termasuk tempat Kishibe menguji Denji dan Power.", rateDevil: 0.20 },
    { nama: "Kamar Hotel Kyoto", desc: "Penginapan tradisional tempat divisi 4 beristirahat sementara selama perjalanan ke Kyoto.", rateDevil: 0.15 },
    { nama: "Sungai Bawah Underground Shinjuku", desc: "Saluran air tempat sisa pertarungan melawan Iblis mengalir setelah dibersihkan.", rateDevil: 0.40 },
    { nama: "Halte Bus Distrik Chuo", desc: "Tempat duduk umum di mana Kobeni merenungi nasib buruknya setelah mobil barunya hancur.", rateDevil: 0.20 },
    { nama: "Toko Buku Jimbocho", desc: "Kawasan toko buku tua yang dilewati dan membangun atmosfer romantis cerita Reze.", rateDevil: 0.15 },
    { nama: "Aoi Building", desc: "Gedung berarsitektur retro khas era Showa yang dilewati Reze dalam rute perjalanannya.", rateDevil: 0.20 },
    { nama: "Gang Sempit Kanda (Alley)", desc: "Gang sunyi di dekat kafe, tempat tragis di mana Makima/Angel Devil mencegat Reze.", rateDevil: 0.45 },
    { nama: "Kamar Hotel Quanxi", desc: "Tempat Quanxi bersantai bersama pacar-pacar fiend-nya sebelum mulai beraksi.", rateDevil: 0.30 },
    { nama: "Kamar Sewaan Tiga Bersaudara", desc: "Kamar penginapan murah tempat tiga bersaudara pembunuh bayaran asal Amerika menyusun rencana.", rateDevil: 0.25 },
    { nama: "Restoran Mewah Tokyo", desc: "Tempat makan malam mewah di mana Kurose dan Tendo menjamu rekannya sebelum disergap.", rateDevil: 0.35 },
    { nama: "Jalan Raya Pinggiran Kota", desc: "Lokasi mobil patroli Public Safety diberondong peluru oleh mobil kloningan Santa Claus.", rateDevil: 0.50 },
    { nama: "Toko Suvenir", desc: "Toko kecil tempat Aldo (pembunuh bayaran) bersembunyi dengan menyamar menggunakan topeng.", rateDevil: 0.15 },
    { nama: "Pusat Keramaian Shibuya", desc: "Latar jalanan silang ikonik di mana Denji versi Chainsaw Man dikerumuni oleh warga.", rateDevil: 0.60 },
    { nama: "Fasilitas Medis Public Safety", desc: "Laboratorium khusus tempat autopsi iblis dan pemulisan hibrida.", rateDevil: 0.25 },
    { nama: "Pusat Pelatihan Divisi 4", desc: "Ruang olahraga dalam ruangan tempat latihan fisik pemburu iblis.", rateDevil: 0.20 },
    { nama: "Atap Bioskop Tokyo", desc: "Tempat Denji dan Makima berdiskusi santai setelah maraton menonton film bersama.", rateDevil: 0.15 },
    { nama: "Kedai Es Krim Tokyo", desc: "Tempat rekreasi sekilas tempat Power pertama kali mencoba makanan manis manusia.", rateDevil: 0.10 },
    { nama: "Pasar Tradisional Tokyo", desc: "Area keramaian tempat Aki Hayakawa sesekali berbelanja sayur segar untuk menu makan malam.", rateDevil: 0.15 },
    { nama: "Toko Baju Bekas Shinjuku", desc: "Toko murah yang didatangi Denji untuk mencari jaket ganti setelah pakaian lamanya robek.", rateDevil: 0.15 },
    { nama: "Ruang Interogasi Public Safety", desc: "Kamar berjeruji besi dengan lampu temaram untuk menginterogasi mata-mata yakuza.", rateDevil: 0.20 },
    { nama: "Family Burger", desc: "Restoran cepat saji tempat Kobeni bekerja dan lokasi adegan ikonik burger.", rateDevil: 0.40 },
    { nama: "Taman Kota Tokyo (Park)", desc: "Taman bermain anak dengan ayunan, tempat Denji merenon setelah kematian Aki.", rateDevil: 0.30 },
    { nama: "Kamar Rawat Bayi (Nursery Room)", desc: "Fasilitas sekilas yang hancur saat Gun Devil melintasi wilayah Jepang.", rateDevil: 0.75 },
    { nama: "Gudang Senjata Public Safety", desc: "Ruang penyimpanan pedang khusus milik Aki dan perlengkapan anti-iblis lainnya.", rateDevil: 0.15 },
    { nama: "Area Kontainer Pelabuhan", desc: "Latar pelabuhan tempat transaksi ilegal organ iblis oleh para yakuza kelas teri.", rateDevil: 0.45 },
    { nama: "Jembatan Penyeberangan Tokyo", desc: "Lokasi sekilas tempat Asa Mitaka berdiri memandang kota sebelum diserang Justice Devil.", rateDevil: 0.35 },
    { nama: "Koridor Gedung Sekolah", desc: "Area loker sepatu tempat Asa Mitaka dijauhi dan dikerjai oleh teman sekelasnya.", rateDevil: 0.25 },
    { nama: "Gerbang Utama SMA Fourth East", desc: "Tempat para jurnalis dan pengikut Gereja Chainsaw Man berkumpul untuk demonstrasi.", rateDevil: 0.40 },
    { nama: "Pusat Bowling Tokyo", desc: "Tempat rekreasi sekilas yang dilewati karakter saat suasana kota sedang damai.", rateDevil: 0.15 },
    { nama: "Ruang Klub Pemburu Iblis SMA", desc: "Ruang klub sekolah tempat Asa pertama kali didekati oleh anggota OSIS.", rateDevil: 0.30 },
    { nama: "Atap SMA Fourth East", desc: "Lokasi sepi tempat Yoshida sering mengawasi Denji agar identitasnya rahasia.", rateDevil: 0.30 },
    { nama: "Pos Polisi Sektor Tokyo", desc: "Kantor polisi lokal tempat penanganan kasus kriminal biasa sebelum dialihkan ke Public Safety.", rateDevil: 0.20 },
    { nama: "Toko Hewan Peliharaan (Pet Shop)", desc: "Toko tempat Nayuta dan Denji membeli makanan untuk anjing peliharaan mereka.", rateDevil: 0.15 },
    { nama: "Kantor Detektif Swasta", desc: "Ruang kerja tertutup milik pemburu swasta untuk menerima berkas pesanan warga.", rateDevil: 0.25 },
    { nama: "Klinik Gelap Pasar Hitam", desc: "Tempat medis ilegal untuk merawat luka hibrida atau memperjualbelikan bagian tubuh iblis.", rateDevil: 0.40 },
    { nama: "Studio Berita TV Tokyo", desc: "Stasiun penyiaran tempat jurnalis menyebarkan berita kemunculan Chainsaw Man.", rateDevil: 0.30 },
    { nama: "Kedai Teh Tradisional (Tea House)", desc: "Tempat tersembunyi para petinggi pemerintah melakukan rapat rahasia.", rateDevil: 0.20 },
    { nama: "Dimensi Batas Pikiran (Mindscape)", desc: "Ruang bawah sadar dalam mimpi Denji, tempat pintu merah Pochita berada.", rateDevil: 0.50 },
    { nama: "Dunia Penuaan (Aging's World)", desc: "Dimensi abstrak surealis milik Aging Devil yang sempat diakses di manga Part 2.", rateDevil: 0.80 },
    { nama: "Rumah Perlindungan Public Safety (Safehouse)", desc: "Rumah rahasia tempat bersembunyi Denji dari kejaran para assassin internasional.", rateDevil: 0.25 },
    { nama: "Atap Rumah Sakit Tokyo", desc: "Tempat Kishibe memantau kondisi Aki sekaligus berdiskusi rahasia untuk melawan Makima.", rateDevil: 0.25 },
    { nama: "Lorong Bawah Tanah Penahanan", desc: "Koridor sempit menuju sel penjara khusus tempat para pemburu menaruh jimat pelindung.", rateDevil: 0.70 },
    { nama: "Kafe Retro Tokyo", desc: "Kafe tempat Denji dan Makima minum kopi dan menangis bersama setelah dari bioskop.", rateDevil: 0.15 },
    { nama: "Toko Kue Sus (Choux Cream Shop)", desc: "Toko makanan manis tempat Denji membelikan kue sus untuk Asa Mitaka saat mengobrol santai.", rateDevil: 0.10 },
    { nama: "Pusat Penyelamatan Publik", desc: "Bunker perlindungan darurat tempat warga berkumpul saat terjadi serangan iblis skala besar.", rateDevil: 0.35 },
    { nama: "Halaman Belakang SMA", desc: "Tempat sepi di lingkungan sekolah di mana Yoru pertama kali menguji kekuatan senjatanya.", rateDevil: 0.30 },
    { nama: "Toko Kaset Video", desc: "Toko sekilas tempat Denji melihat-lihat cover film lama sebelum pergi bersama Makima.", rateDevil: 0.10 },
    { nama: "Atap Gedung Apartemen Tokyo", desc: "Tempat bertarung jangka pendek hibrida lain saat menantang Chainsaw Man.", rateDevil: 0.40 },
    { nama: "Pusat Informasi Kota", desc: "Fasilitas sekilas yang menyediakan peta fisik Tokyo sebelum era smartphone.", rateDevil: 0.15 },
    { nama: "Jalan Setapak Sungai", desc: "Area bantaran sungai tempat Asa Mitaka merenungi hidupnya yang penuh kesialan.", rateDevil: 0.20 },
    { nama: "Area Parkir Bawah Tanah", desc: "Tempat persembunyian yakuza kroco dari kejaran divisi Keamanan Publik.", rateDevil: 0.35 },
    { nama: "Gedung Teater Tua", desc: "Gedung pertunjukan terbengkalai tempat salah satu bawahan iblis menunggu instruksi.", rateDevil: 0.45 },
    { nama: "Stasiun Pengisian Bahan Bakar", desc: "Pom bensin pinggir kota yang dilewati mobil operasional Public Safety saat patroli malam.", rateDevil: 0.20 },
    { nama: "Toko Elektronik Akihabara", desc: "Toko TV sekilas yang menampilkan siaran langsung amukan Chainsaw Man di jalanan.", rateDevil: 0.15 }
];
...
export function parseBonus(bonusStr, target) {
  ...
  if (bonusStr.includes('Concept Erasure')) target.conceptErasure = true;
  ...
  else if (bonusStr.includes('Weapon Damage') || bonusStr.includes('Gun Damage') || bonusStr.includes('dmg') || bonusStr.includes('atk')) target.dmg += val;
  ...
  else if (bonusStr.includes('Accuracy') || bonusStr.includes('accuracy')) target.accuracy += val;
  else if (bonusStr.includes('Speed') || bonusStr.includes('Attack Speed') || bonusStr.includes('speed')) target.speed += val;
  ...
  else if (bonusStr.includes('CC') || bonusStr.includes('cc')) target.cc += val;
  ...
  else if (bonusStr.includes('Money') || bonusStr.includes('goldMult')) target.money += val;
  ...
  else if (bonusStr.includes('Control Enemy') || bonusStr.includes('control')) target.control = (target.control || 0) + (val || 1);
  else if (bonusStr.includes('CC Resist') || bonusStr.includes('ccResist')) target.ccResist = (target.ccResist || 0) + val;
  else if (bonusStr.includes('Summon Doll') || bonusStr.includes('summon') || bonusStr.includes('summonBuff')) target.summon = (target.summon || 0) + (val || 1);
  else if (bonusStr.includes('Doll Buff') || bonusStr.includes('dollBuff')) target.dollBuff = (target.dollBuff || 0) + val;
  else if (bonusStr.includes('Self Destruct') || bonusStr.includes('selfDestruct')) target.selfDestruct = (target.selfDestruct || 0) + val;
  else if (bonusStr.includes('Political Power') || bonusStr.includes('political')) target.political = (target.political || 0) + (val || 1);
  else if (bonusStr.includes('Army Buff') || bonusStr.includes('army')) target.army = (target.army || 0) + val;
  else if (bonusStr.includes('Law') || bonusStr.includes('law')) target.law = (target.law || 0) + val;
  else if (bonusStr.includes('Diplomacy') || bonusStr.includes('diplomacy')) target.diplomacy = (target.diplomacy || 0) + val;
  else if (bonusStr.includes('Crime') || bonusStr.includes('crime')) target.crime = (target.crime || 0) + val;
  else if (bonusStr.includes('INT') || bonusStr.includes('int')) target.int = (target.int || 0) + val;
  else if (bonusStr.includes('Justice') || bonusStr.includes('justice')) target.justice = (target.justice || 0) + val;
  else if (bonusStr.includes('Taunt') || bonusStr.includes('taunt')) target.taunt = (target.taunt || 0) + (val || 1);
  else if (bonusStr.includes('Snake Summon') || bonusStr.includes('snake')) target.snake = (target.snake || 0) + (val || 1);
...
export function calcBonus(csm) {
  ...
  for (let key in setBonus) {
    if (typeof b[key] === 'boolean') {
      b[key] = b[key] || !!setBonus[key]
    } else {
      b[key] = (b[key] || 0) + setBonus[key]
    }
  }
...
export function checkAchievements(csm) {
  ...
  let unlocked = []
  for (let ach of ACHIEVEMENT_LIST) {
    if (!csm.achievements.includes(ach.id) && ach.check(csm)) {
      csm.achievements.push(ach.id)
      unlocked.push(ach)
    }
  }
  return unlocked
