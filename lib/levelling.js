...
export const ROLES = [
  ...
  { level: 5, title: 'Novice Adventurer' },
  { level: 10, title: 'Apprentice' },
  { level: 20, title: 'Iron Warrior' },
  { level: 35, title: 'Silver Knight' },
  { level: 50, title: 'Golden Champion' },
  { level: 75, title: 'Diamond Master' },
  { level: 100, title: 'Grandmaster' },
  { level: 130, title: 'Epic Sovereign' },
  { level: 165, title: 'Legendary Hero' },
  { level: 200, title: 'Mythic Immortal' }
]
...
export async function checkLevelUp(m, conn) {
  ...
  if (!user || user.autolevelup === false) return false
