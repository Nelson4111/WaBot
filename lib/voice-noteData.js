...
export const VOICE_NOTE_GROUPS = [
  ...
  {
    files: ['adaapa.m4a'],
    commands: ['tes', 'test', 'woi', 'p', 'pp', 'woy', 'weh', 'min', 'admin', 'pe', 'ada apa'],
  },
  { files: ['SayaRobot.opus'], commands: ['bot', 'bott', 'robot'] },
  { files: ['gaboleh.m4a'], commands: ['sc', 'script', 'code','ga boleh', 'gaboleh', 'repo', 'repository'] },
  ...
  { files: ['zeta-halo-guys.mp3'], commands: ['zeta halo guys', 'halo guys', 'halo', 'hi', 'hello', 'alo', 'ges', 'guys'] },
