...
extends TaskProcessChunkBase {
    ...
    protected boolean canProcessChunk(ChunkPos pos) {
        ...
        if ((EntityDataManager.getInstance().hasServuxServer() || EntityDataManager.getInstance().getIfReceivedBackupPackets()) && Objects.equals(EntityDataManager.getInstance().getBestWorld(), this.clientWorld)) {
            if (EntityDataManager.getInstance().hasCompletedChunk(pos)) {
                return this.areSurroundingChunksLoaded(pos, this.clientWorld, 0);
            }
            if (!EntityDataManager.getInstance().hasPendingChunk(pos)) {
    ...
    protected boolean processChunk(ChunkPos pos) {
        ...
        if ((EntityDataManager.getInstance().hasServuxServer() || EntityDataManager.getInstance().getIfReceivedBackupPackets()) && EntityDataManager.getInstance().hasCompletedChunk(pos) && Objects.equals(EntityDataManager.getInstance().getBestWorld(), this.clientWorld)) {
