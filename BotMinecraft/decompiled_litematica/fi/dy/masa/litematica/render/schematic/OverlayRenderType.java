...
public enum OverlayRenderType {
    OUTLINE(MaLiLibPipelines.DEBUG_LINES_MASA_SIMPLE_OFFSET_2, MaLiLibPipelines.DEBUG_LINES_MASA_SIMPLE_NO_DEPTH_NO_CULL, PrimitiveTopology.DEBUG_LINES, 0, false),
    QUAD(MaLiLibPipelines.POSITION_COLOR_TRANSLUCENT_LEQUAL_DEPTH_OFFSET_2, MaLiLibPipelines.POSITION_COLOR_TRANSLUCENT_NO_DEPTH_NO_CULL, PrimitiveTopology.QUADS, 0, true);
    ...
    private OverlayRenderType(RenderPipeline pipeline, RenderPipeline renderThrough, PrimitiveTopology topology, int index, boolean translucent) {
    ...
    public RenderPipeline renderThrough() {
    ...
    public int expectedBufferSize() {
        return this.vertexFormat().getVertexSize() * 4;
    }
