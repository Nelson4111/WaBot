...
public class ChunkRenderGpuBuffers
implements AutoCloseable {
    ...
    protected ChunkRenderGpuBuffers(Supplier<String> name, GpuBuffer vertexBuffer, @Nullable GpuBuffer indexBuffer, int indexCount, IndexType indexType) {
        this.name = name;
