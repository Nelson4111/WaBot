...
implements AutoCloseable {
    ...
    private volatile ChunkMeshDataSchematic meshDataCache = new ChunkMeshDataSchematic();
    private final Set<ChunkSectionLayer> blockLayersUsed = EnumSet.noneOf(ChunkSectionLayer.class);
    private final Set<ChunkSectionLayer> blockLayersStarted = EnumSet.noneOf(ChunkSectionLayer.class);
    private final Set<OverlayRenderType> overlayLayersUsed = EnumSet.noneOf(OverlayRenderType.class);
    private final Set<OverlayRenderType> overlayLayersStarted = EnumSet.noneOf(OverlayRenderType.class);
    ...
    public static class RenderDataComparator
    implements Comparator<ChunkRenderDataSchematic> {
        @Override
        public int compare(ChunkRenderDataSchematic o1, ChunkRenderDataSchematic o2) {
            ...
            int layersStartedCompare = Integer.compare(o1.blockLayersStarted.size(), o2.blockLayersStarted.size());
            int overlaysStartedCompare = Integer.compare(o1.overlayLayersStarted.size(), o2.overlayLayersStarted.size());
            if (layersStartedCompare != 0 || overlaysStartedCompare != 0) {
                return layersStartedCompare > 0 ? 1 : overlaysStartedCompare;
            }
            int layersUsedCompare = Integer.compare(o1.blockLayersUsed.size(), o2.blockLayersUsed.size());
            int overlaysUsedCompare = Integer.compare(o1.overlayLayersUsed.size(), o2.overlayLayersUsed.size());
