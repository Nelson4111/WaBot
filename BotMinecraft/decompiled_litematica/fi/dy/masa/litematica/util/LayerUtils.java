...
public class LayerUtils {
    private static final long LAYER_REPEAT_DELAY_MS = 400L;
    private static final long LAYER_REPEAT_INTERVAL_MS = 50L;
    ...
    public static void onClientTick(Minecraft mc) {
        if (Configs.Generic.LAYER_MODE_DYNAMIC.getBooleanValue()) {
            ...
            LayerUtils.layerChangeRepeatTick();
        }
    }
    ...
    public static void layerChangeRepeatTick() {
        ...
        if (currentDir != 0) {
            ...
            } else if (now - layerRepeatStartTime >= 400L && now - layerLastRepeatTime >= 50L) {
