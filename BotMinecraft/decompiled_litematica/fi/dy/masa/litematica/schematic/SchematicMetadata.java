...
public class SchematicMetadata {
    ...
    public FileType getFileType() {
        return (FileType)((Object)Objects.requireNonNullElse((Object)((Object)this.type), (Object)((Object)FileType.UNKNOWN)));
    }
    ...
    public CompoundTag writeToNBT() {
        ...
        nbt.put("EnclosingSize", (Tag)NbtUtils.createVec3iTag((Vec3i)this.enclosingSize));
        if (this.thumbnailPixelData != null) {
            int[] result = this.thumbnailPixelData.toArray();
            if (result.length > 0) {
    ...
    public void readFromNBT(CompoundTag nbt) {
        ...
        if (nbt.contains("EnclosingSize") && (size = NbtUtils.readVec3iFromTag((CompoundTag)nbt.getCompoundOrEmpty("EnclosingSize"))) != null) {
            this.enclosingSize = size;
        }
        this.thumbnailPixelData = nbt.contains("PreviewImageData") ? Arrays.stream(nbt.getIntArray("PreviewImageData").orElse(new int[0])) : null;
    }
